...
class RightPanel(ft.Container):
    ...
    def build_ui(self):
        ...
        return ft.Column([
            ft.Container(
                content=ft.Column([
                    ft.Container(content=self.img_preview, expand=True, alignment=ft.alignment.center, bgcolor=ft.colors.SURFACE_VARIANT, border_radius=8),
            ...
            ft.Container(
                content=ft.Column([
                    ...
                    self.progress_bar,
                    self.lbl_progress,
                    ft.Container(content=self.log_list, expand=True, bgcolor=ft.colors.SURFACE_VARIANT, border_radius=5, padding=5)
                ]),
                expand=True,
                border=ft.border.all(1, ft.colors.OUTLINE),
                border_radius=8,
    ...
    def update_selection_after_rotate(self):
        if self.current_preview_file:
            ...
            self.update_selection([first_file], False, "4") # Simplify re-render
